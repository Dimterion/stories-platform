...
import { BookOpenCheck, CircleQuestionMark, Pencil } from "lucide-react";
  ...
  return (
    <main className="flex flex-col items-center gap-10 p-4">
      ...
      <button
        ...
        className="hover:bg-softWhite hover:text-deepBlue mx-auto flex w-sm max-w-[80vw] cursor-pointer flex-nowrap items-center justify-center gap-2 border p-2 text-center uppercase"
      >
      ...
      <section className="flex flex-col gap-10 text-center">
        <article className="flex flex-col gap-4">
          ...
          <Link
            to="/story-player"
            className="hover:bg-softWhite hover:text-deepBlue mx-auto flex w-sm max-w-[80vw] flex-nowrap items-center justify-center gap-2 border p-2 text-center uppercase"
          >
            <BookOpenCheck />
            Story Player
          </Link>
